...
.. autoclass:: pyrf24.fake_ble.FakeBLE
    ...
    .. seealso::
        ...
        :py:class:`~pyrf24.rf24.RF24` class' constructor documentation.

.. autoattribute:: pyrf24.fake_ble.FakeBLE.mac
...
.. autoattribute:: pyrf24.fake_ble.FakeBLE.name
...
.. autoattribute:: pyrf24.fake_ble.FakeBLE.show_pa_level
...
.. automethod:: pyrf24.fake_ble.FakeBLE.hop_channel

.. automethod:: pyrf24.fake_ble.FakeBLE.whiten
    ...
    .. note:: `advertise()` and
        :meth:`~pyrf24.fake_ble.FakeBLE.available()` uses
    ...
    .. warning:: This function uses the currently set BLE channel as a
        ...
        Do not call :meth:`~pyrf24.fake_ble.FakeBLE.hop_channel()` before calling
...
.. automethod:: pyrf24.fake_ble.FakeBLE.len_available
    ...
    .. versionchanged:: 2.0.0
        ...
        :py:func:`pyrf24.rf24.RF24.available()`. This change also
        allows providing the underlying `RF24` class'
        :py:func:`~pyrf24.rf24.RF24.available()` method in the
        `FakeBLE` API.

.. automethod:: pyrf24.fake_ble.FakeBLE.advertise
...
.. automethod:: pyrf24.fake_ble.FakeBLE.available
...
.. autoattribute:: pyrf24.fake_ble.FakeBLE.rx_queue

    Each Element in this queue is a `QueueElement` object whose members are set according to the
    its internal decoding algorithm. The :meth:`~pyrf24.fake_ble.FakeBLE.read()`
...
.. autoattribute:: pyrf24.fake_ble.FakeBLE.rx_cache
...
.. automethod:: pyrf24.fake_ble.FakeBLE.read
